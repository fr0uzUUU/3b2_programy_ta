...
bool MainWindow::Wygrana(){
    if (ui->p1->text() == "1" && ui->p2->text()=="2" && ui->p3->text() == "3"
            && ui->p4->text() == "4" && ui->p5->text() == "5" && ui->p6->text() == "6"
            && ui->p7->text() == "7" && ui->p8->text() == "8"){
        return true;
    }else {
        return false;
    }
...
void MainWindow::on_pushButton_clicked()
{
    if (ui->p1->text() == "1" && ui->p2->text()=="2" && ui->p3->text() == "3"
        ...
        wynik.setStyleSheet("QLabel{min-width:200 px; font-size: 13px;} QPushButton{ width:25px; font-size: 13px; }");
        wynik.exec();
    }
}
